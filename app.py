...
# --- 5. CONTROLES SUPERIORES (MANTENIENDO TU LÓGICA) ---
        ...
        with st.popover("📍 ¿A quién cobro hoy?", use_container_width=True):
            ...
            if not st.session_state.lista_ruta:
                ...
                if con_gps:
                    ...
                    url_maps = f"https://www.google.com/maps/dir/Current+Location/{puntos}"
    ...
    if modo_analisis:
        ...
        # Ordenamos de facturas nuevas a viejas (fecha_creacion DESC)
        query = query.order("fecha_creacion", descending=True)
